...
export class NewGameWarning extends PIXI.Container {
	constructor(homeScreen: () => void, newGame: () => void) {
		...
		// Position text
		newGameWarningText.position.set((800 - newGameWarningText.width) / 2, (600 - newGameWarningText.height) / 2);
		...
		// Position text
		newGameWarningTextLineTwo.position.set((800 - newGameWarningTextLineTwo.width) / 2, (700 - newGameWarningTextLineTwo.height) / 2);
		// Add text to the canvas
		...
		// Position the button
		cancelButton.position.set((600 - cancelButton.width) / 2, (900 - cancelButton.height) / 2);
		...
		// Position the button
		proceedButton.position.set((1000 - proceedButton.width) / 2, (900 - proceedButton.height) / 2);
		// Add the button to the canvas
