...
export class CreditsScreen extends PIXI.Container {
	...
	constructor(borderImage: PIXI.Texture, settings: () => void) {
		...
		musicText.position.set((800 - musicText.width) / 2, (300 - musicText.height) / 2);
		...
		const backToSettingsButton = new Button(25, "X", undefined, undefined, settings);
		// Set position
		backToSettingsButton.position.set(675, (135 - backToSettingsButton.height) / 2);
