...
export class Clock extends PIXI.Container{
  ...
  constructor(game: Game) {
    ...
    this.clockContainer.position.set(700, 40); // Positie van de klok
    this.clockContainer.scale.set(0.20); // Formaat van de klok
  ...
  public drawClock() {
    ...
    this.clockGraphics.lineStyle(12, 0x0000ff); // Blauwe kleur
    this.clockGraphics.moveTo(200, 200);
